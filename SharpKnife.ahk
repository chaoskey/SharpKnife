...
if FileExist(cvsFile) {
    Loop read, cvsFile {
        ...
        if (t2 > 0) {
            ...
            if (f2 != "" && f3 != "")
                cvsEntries.Push({key: key, f2: f2, f3: f3, hasF3: true})
        } else {
            ; 只有第二字段
            if (rest != "")
                cvsEntries.Push({key: key, f2: rest, f3: "", hasF3: false})
        }
    }
}
...
; ============================================================================
; 9b. 处理 LaTeX 模板：处理 {Text} 前缀与 ##{Left N} 标记
; ============================================================================
